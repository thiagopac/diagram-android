    ...
    public static void install(final InputStream in, final String sEngine) {
        new Thread(new Runnable() {
            public void run() {
                ...
                try {
                    OutputStream out = new FileOutputStream("/data/data/club.diagram.chess/" + sEngine);
                    ...
                    runConsole("/system/bin/ls /data/data/club.diagram.chess/");
                    runConsole("/system/bin/chmod 744 /data/data/club.diagram.chess/" + sEngine);
